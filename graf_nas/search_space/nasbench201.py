...
class NB201(NetBase):
    ...
    def to_naslib(self, n_classes):
        return convert_to_naslib(self.net, NasBench201SearchSpace, n_classes=n_classes)
    ...
    @staticmethod
    def get_arch_iterator(dataset_api, n_classes=10):
        if NB201.naslib_object is None:
            NB201.naslib_object = NasBench201SearchSpace(n_classes=n_classes)
